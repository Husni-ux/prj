...
let a = "https://restcountries.com/v3.1/all",
  ...
  b=  "https://restcountries.com/v3.1/currency/",
  p = document.querySelector(".photo");

function f(n, t, i, o, e , x) {
...
function s(n) {
  fetch(n).then(t => (console.log(t), t.json())).then(t => {
    t = t.slice(0, 15);
    let i = "";
    t.forEach(function (o) {
      o.capital && (i += f(o.flags.png, o.name.official, o.population, o.region, o.capital[0] , o.currencies))
    }), p.innerHTML = i
  })
}
s(a);
